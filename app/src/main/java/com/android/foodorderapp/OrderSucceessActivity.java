...
public class OrderSucceessActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    MapView mapView;
    ...
    private final ActivityResultLauncher<String> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        ...
        public void onActivityResult(Boolean result) {
            if (result) {
                Toast.makeText(OrderSucceessActivity.this, "Permission granted! Restart this app", Toast.LENGTH_SHORT).show();
            }
        }
    });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        speechApi = new MapboxSpeechApi(OrderSucceessActivity.this, getString(R.string.mapbox_access_token), Locale.US.toLanguageTag());
        mapboxVoiceInstructionsPlayer = new MapboxVoiceInstructionsPlayer(OrderSucceessActivity.this, Locale.US.toLanguageTag());
        ...
        if (ActivityCompat.checkSelfPermission(OrderSucceessActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(OrderSucceessActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
        ...
        setRoute.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(OrderSucceessActivity.this, "Please select a location in map", Toast.LENGTH_SHORT).show();
            }
        });

        mapView.getMapboxMap().loadStyleUri("mapbox://styles/ansh0407/clsrfjjtc008b01pk0nq61zx2", new Style.OnStyleLoaded() {
            @Override
    ...
    private void fetchRoute(Point point) {
        LocationEngine locationEngine = LocationEngineProvider.getBestLocationEngine(OrderSucceessActivity.this);
            ...
            public void onSuccess(LocationEngineResult result) {
                ...
                mapboxNavigation.requestRoutes(builder.build(), new NavigationRouterCallback() {
                    ...
                    public void onFailure(@NonNull List<RouterFailure> list, @NonNull RouteOptions routeOptions) {
                        setRoute.setEnabled(true);
                        setRoute.setText("Set route");
                        Toast.makeText(OrderSucceessActivity.this, "Route request failed", Toast.LENGTH_SHORT).show();
                    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.subscription:
                startActivity(new Intent(OrderSucceessActivity.this, SubscriptionActivity.class));
                break;
            case R.id.profile:
                startActivity(new Intent(OrderSucceessActivity.this, ProfileActivity.class));
                break;
            case R.id.about_us:
